...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-zinc-950 selection:bg-zinc-900 selection:text-white font-sans">
      ...
      <main className="flex-1 space-y-24 py-24 md:space-y-32 md:py-32">
        {/* Hero */}
        <section className="max-w-4xl mx-auto px-6 pt-12 text-center flex flex-col items-center">
          ...
          <p className="max-w-2xl text-lg md:text-xl text-zinc-500 leading-relaxed mb-12">
          ...
          <div className="mt-20 relative w-full aspect-video rounded-2xl md:rounded-[3rem] overflow-hidden border border-zinc-100 shadow-sm">
            <Image
        ...
        {/* Features */}
        <section id="problem" className="max-w-4xl mx-auto px-6 text-center py-24 border-t border-zinc-100">
          <span className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400 mb-6 block">Features</span>
          ...
          <div className="max-w-2xl mx-auto space-y-8 text-zinc-500 text-lg leading-relaxed mb-16">
            ...
            <p>It&apos;s messy, inconsistent, and fundamentally broken. Our counters deserve better.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
            {[
              { title: "Messy", desc: "Kitchen counters covered in protein dust." },
              { title: "Unsanitary", desc: "Hands digging in your supplements." },
              { title: "Slow", desc: "Searching for the 'bottom of the tub' scoop." },
              { title: "Wasteful", desc: "Losing grams of powder with every spill." }
            ].map((item, i) => (
              <div key={i} className="p-8 bg-zinc-50 border border-zinc-100 rounded-2xl">
                <h4 className="font-extrabold uppercase text-xs tracking-widest mb-2">{item.title}</h4>
        ...
        {/* Solution */}
        <section className="max-w-4xl mx-auto px-6 text-center py-24 border-t border-zinc-100">
          <span className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400 mb-6 block">The Solution</span>
          <h2 className="text-4xl md:text-7xl font-black tracking-tighter uppercase leading-none mb-10">
            Precision <br />Meets Performance.
          </h2>
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-zinc-500 leading-relaxed">
            Scoopii replaces bulky tubs and messy scoops with a sleek, sealed dispenser that delivers a precise dose directly into your bottle with one hand.
          </p>
        </section>

        {/* How It Works */}
        <section id="how-it-works" className="max-w-7xl mx-auto px-6 py-24 border-t border-zinc-100">
          <div className="grid md:grid-cols-3 gap-16">
            {[
              ...
              { step: "03", title: "Pour", desc: "One click dispenses your calibrated dose. Clean, fast, and satisfying." }
            ].map((item, i) => (
              <div key={i} className="flex flex-col items-center text-center">
                <div className="text-5xl md:text-7xl font-black text-zinc-100 mb-6">{item.step}</div>
                <h3 className="text-2xl font-black uppercase tracking-tighter mb-4">{item.title}</h3>
                <p className="text-zinc-500 leading-relaxed text-sm max-w-[200px]">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* Use Cases */}
        <section className="max-w-7xl mx-auto px-6 py-24 border-t border-zinc-100 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="p-10 bg-zinc-50 rounded-3xl border border-zinc-100 flex flex-col items-center">
        ...
        <section className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 border border-zinc-100 rounded-[3rem] overflow-hidden shadow-xl">
            <div className="p-12 md:p-16 border-b md:border-b-0 md:border-r border-zinc-100 bg-white">
              <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400 mb-8">Legacy Tubs</h4>
              <ul className="space-y-6">
                {["Constant spills", "Unsanitary digging", "Ugly counter clutter", "Guessing portions"].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 text-zinc-400 text-sm font-bold uppercase italic">
            ...
            <div className="p-12 md:p-16 bg-zinc-950 text-white">
              <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-500 mb-8">Scoopii System</h4>
              <ul className="space-y-6">
                {["Zero mess", "Contactless pouring", "Award-winning design", "Precision calibrated"].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 text-sm font-black uppercase tracking-wide">
        ...
        {/* Pre-Order CTA */}
        <section id="pre-order" className="max-w-7xl mx-auto px-6">
          <div className="bg-zinc-50 rounded-[3rem] md:rounded-[4rem] border border-zinc-100 p-12 md:p-32 text-center flex flex-col items-center">
            ...
            <p className="max-w-xl text-lg text-zinc-500 mb-12">
            ...
            <form id="pre-order-form" action={handleSubmit} className="w-full max-w-xl space-y-4">
              ...
              <button
                ...
                className="w-full bg-zinc-950 text-white h-14 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-zinc-800 transition-colors disabled:opacity-50"
              >
        ...
        {/* Footer */}
        <footer className="max-w-7xl mx-auto px-6 border-t border-zinc-100 pt-24 pb-12">
          <div className="flex flex-col md:flex-row justify-between gap-12 mb-20">
            <div>
              <div className="flex items-center gap-1 font-black tracking-tighter text-2xl uppercase italic mb-6 select-none">
              ...
              <p className="text-zinc-500 max-w-xs text-sm leading-relaxed">
                Modernizing the supplement experience with lab-grade precision and premium aesthetics.
              </p>
            </div>
          </div>
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-zinc-50 gap-4">
